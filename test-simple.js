...
try {
    require('child_process').execSync('npm run compile', { stdio: 'ignore' });
    console.log('✓ Test 3: TypeScript compilation - PASSED');
} catch (e) {
    console.error('✗ Test 3: TypeScript compilation - FAILED');
    process.exit(1);
}
